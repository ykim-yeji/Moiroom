...
public class MemberController {
    ...
    public ApiResponse<?> addCharacteristic(HttpServletRequest request, @RequestBody CharacteristicAndInterestInfo.CharactAndInterInfoResquest infoAddModifyReq) {
